    ...
    <section id="about" className="py-24 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto">
        ...
        >
          ...
          <p className="text-lg leading-relaxed mb-6 font-serif">
            I move between the structured conduct of business development and the codified dynamism of decentralized systems, bringing both analytical precision and creative insight to every project. Here to make finance more fascinating and blockchain less bewildering, one project at a time.
          </p>
          <p className="text-lg leading-relaxed mb-6 font-serif">
          ...
          <p className="text-lg leading-relaxed font-serif">
            ...
            <a 
              href="https://drive.google.com/file/d/1q9veK98aZXB0rbpT5UsBip8ysukitFMG/view?usp=sharing"
              target="_blank"
